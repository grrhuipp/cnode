...
string(FIND "${CONTROLLER_SOURCE}"
    "std::exception_ptr candidate_failure" TRANSITION_BEGIN)
string(FIND "${CONTROLLER_SOURCE}"
...
string(FIND "${TRANSITION_SOURCE}"
    "node_configs_[panel] = fetched_config" CONFIG_COMMIT)

if(OLD_OUTBOUND_CLEANUP EQUAL -1 OR OLD_RULE_CLEANUP EQUAL -1 OR
   NEW_RULE_COMMIT EQUAL -1 OR CONFIG_COMMIT EQUAL -1)
...
if(NOT OLD_OUTBOUND_CLEANUP LESS OLD_RULE_CLEANUP OR
   ...
   NOT NEW_RULE_COMMIT LESS CONFIG_COMMIT)
    message(FATAL_ERROR
        "old tag cleanup and new rules must finish before node config commit")
endif()
