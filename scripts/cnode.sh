...
ALLOWED_OPTIONS="name api_host api_key node_id node_type dns tls_enable tls_cert tls_key outbound_url route_url inbound_url"
...
install_cnode() {
    ...
    # 获取远程 build_id
    RELEASE_INFO=$(curl -sf "https://api.github.com/repos/$REPO/releases/tags/latest")
    ...
    if [ -z "$LATEST_URL" ] || [ "$LATEST_URL" = "null" ]; then
        LATEST_URL="https://github.com/$REPO/releases/latest/download/cnode-linux-amd64"
    fi
